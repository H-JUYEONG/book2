...
public class BookApp {
	...
	public static void main(String[] args) {
		...
		List<Book2Vo> bookList = bookDao.selectBookAll();
		...
		while (true) {
			...
			for (int i = 0; i < bookList.size(); i++) {
				...
				String authorName = bookList.get(i).getName();

				if (title.contains(keyword) || pubs.contains(keyword) || authorName.contains(keyword)) {
